// A tweaked version of the p5.js "flocking" example at https://p5js.org/examples/classes-and-objects-flocking/

let flock;

// Colors
const brandColors = ["#457A83", "#4AA5A3", "#4D80A1", "#C6909E", "#C3B139"];
const backgroundColor = "#F6F4EF";
...
class Boid {
  constructor(x, y) {
    ...
    //Boid color
    this.color = color(random(brandColors));
  }
